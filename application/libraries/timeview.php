...
class timeview {
	...
	?>
			...
			<td class="time" id="task<?=$task['id']?>Time"><?=$this->secsToTime($this->CI->timedb->taskTime($task['id']))?></td>
			<td class="time" id="task<?=$task['id']?>Total"><?=$this->secsToTime($this->CI->timedb->taskTotalTime($task['id']))?></td>
